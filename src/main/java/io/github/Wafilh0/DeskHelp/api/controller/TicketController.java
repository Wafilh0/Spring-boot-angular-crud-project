package io.github.Wafilh0.DeskHelp.api.controller;
...
import io.github.Wafilh0.DeskHelp.api.dto.Summary;
...
import io.github.Wafilh0.DeskHelp.api.response.Response;
import io.github.Wafilh0.DeskHelp.api.security.jwt.JwtTokenUtil;
import io.github.Wafilh0.DeskHelp.api.service.TicketService;
import io.github.Wafilh0.DeskHelp.api.service.UserService;
...
public class TicketController {
	...
	public ResponseEntity<Response<Ticket>> createdOrUpdate(HttpServletRequest request, @RequestBody Ticket ticket, BindingResult result) {
	...
	public ResponseEntity<Response<Ticket>> changeStatus(@PathVariable("id") String id,
		...
		try {
			...
			changeStatus.setUserChanges(userFromRequest(request));
